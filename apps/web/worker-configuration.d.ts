/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6ef78239d14ac9ea53602f3164762d31)
...
interface __BaseEnv_Env {
	...
	ENABLE_PASSWORD_AUTH: string;
	TIMER_ROOM: DurableObjectNamespace<import("./src/worker/index").TimerRoom>;
	CHAT_AGENT: DurableObjectNamespace<import("./src/worker/index").ChatAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ChatAgent" | "TimerRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_CALENDAR_CLIENT_ID" | "GOOGLE_CALENDAR_CLIENT_SECRET" | "ENABLE_PASSWORD_AUTH">> {}
}
