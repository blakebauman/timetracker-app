...
import type { DraftEntry, DraftSource } from "@timetracker/core/schemas";
          ...
          <>
            ...
            {onTotalCard ? (
              <div className="space-y-4 py-2">
                <div className="rounded-container border bg-card p-4">
      ...
      <div className="rounded-container border bg-card p-4">
        ...
        {renaming ? (
          ...
          <button
            ...
            className="mt-2 block w-full rounded-md text-left text-sm font-medium transition-colors duration-fast ease-out-quart hover:text-muted-foreground"
