...
function PopoverContent({
  ...
  align = "center",
  sideOffset = 4,
  // Radix keeps a popover inside the viewport but will happily sit it flush
  // against the edge. The project picker, anchored near the right of the timer
  // bar, measured a right edge at exactly the viewport width — 0px of gutter,
