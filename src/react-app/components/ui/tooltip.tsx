  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // Enter classes are state-prefixed like every other floating surface.
          // Unprefixed, they applied on close too, so the exit ran the entrance
          // and the exit at once.
